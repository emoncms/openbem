...
function update_view(i,o)
{
    ...
    $("#heat_gains_from_water_heating").html(
      monthlyrow("Heat gains from water heating (kWh)",o.heat_gains_from_water_heating,0)
    );
    
    $("#waterheating_gains").html(
      monthlyrow("Heat gains from water heating (Watts)",o.waterheating_gains,0)
    );
