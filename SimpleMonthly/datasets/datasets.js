...
var table_1a = [31,28,31,30,31,30,31,31,30,31,30,31];

var table_1c = [1.1,1.06,1.02,0.98,0.94,0.90,0.90,0.94,0.98,1.02,1.06,1.10];

// Table 1d: Temperature rise of hot water drawn off (∆Tm, in K)
var table_1d = [41.2,41.4,40.1,37.6,36.4,33.9,30.4,33.4,33.5,36.3,39.4,39.9];

// Primary circuit loss factors with solar heating 
var table_h4 = [1.0,1.0,0.94,0.70,0.45,0.44,0.44,0.48,0.76,0.94,1.0,1.0];
